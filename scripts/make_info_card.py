...
# ===========================================================================
HOST = "daffa"   # shown as  daffa@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "CS Student @ Universitas Negeri Jakarta"),
    ("kv", "Focus", "Aspiring Full-Stack Developer"),
    ("kv", "Fuel", "Coffee Enthusiast"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Language", "Python, JavaScript"),
    ("kv", "Frontend", "HTML, CSS, React, Tailwind"),
    ("kv", "Backend", "MySQL, PostgreSQL, Supabase"),
    ("kv", "Tools", "Git, Docker"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building full-stack projects to sharpen real-world skills"),
    ("bul", "Always exploring new tools in web development"),
]
